            ...
            layout=[
                ...
                [
                    ...
                    sg.Combo(
                        ...
                        key=f'{parent}.title.stroke_width', 
                        enable_events=True
                    ),
                ],
                [
                    ...
                    sg.Input(
                        ...
                        key=f'{parent}.title.stroke_color', 
                        size=input_size_color,
                        enable_events=True
                    ),
                    sg.ColorChooserButton('選択')
                ...
                [
                    ...
                    sg.Combo(
                        ...
                        key=f'{parent}.title.y', 
                        enable_events=True
                    ),
                ],
                [
                    self.font.GUI(f'{parent}.title')
                ]
            ]
        )